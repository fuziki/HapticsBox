...
export class CanvasViewModel {
  constructor(canvas) {
    ...
    const intensityGraphConfigs = new GraphConfigs(new Vector2(0, 0), new Vector2(canvas.width, canvas.height / 2), 100, 100);
    const sharpnessGraphConfigs = new GraphConfigs(new Vector2(0, canvas.height / 2), new Vector2(canvas.width, canvas.height / 2), 100, 100);
